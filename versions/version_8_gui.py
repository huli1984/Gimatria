...
def mainProgram(method, choosen_list, my_text):
    ...
    #        word = input()
        ...
        #esempio ritrovamento numero di ricorrenze per data parola nel df di riferimento
        linez = lines.reset_index()
        adam_index = linez.index[linez["words"] == "אדם"]
        print(adam_index, "adam index")
